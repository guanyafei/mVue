...
<style lang="less" scoped>
	.personal{
		.mint-header{
			...
			height: 110rem/32;
			border-bottom: 4rem/32 solid rgba(255,255,255,.5);
		}
		.main{
			...
			.p_info{
				...
				.p_logo{
					...
					img{
		        		...
		        		top:50%;
		        		margin-top: -60rem/32;
		        		margin-left: -60rem/32;
					}
					em{
		                line-height: 250rem/32;
		                margin-left: 120rem/32;
		                margin-top: 30rem/32;
		                padding: 0 40rem/32;
		                font-size: 45rem/32;
		                color:white;
